                    ...
                    {posts.map((post) => {
                        ...
                        return (
                            <div key={post.node.id} className="container mt-5">
                                ...
                                <small className="d-block text-info"><i>Posted on dyjfyukyu {post.node.frontmatter.date}</i>
                                </small>
                                ...
                                >
                                    <small className="d-inline-block ml-3">jjjjjjjjjjjj Read full post</small>
                                </Link>
